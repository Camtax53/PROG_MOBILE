...
class _MemoirePageState extends State<MemoirePage> {
  ...
  Future<int> getRecordLettre() async {
    QuerySnapshot snapshotGameLetttre =
        await recordLettreCollection.where('uid', isEqualTo: uid).get();
  ...
  Future<int> addNewUserIntoFirestoreLettre() async {
    QuerySnapshot snapshotGameLettre =
        await recordLettreCollection.where('uid', isEqualTo: uid).get();
  ...
  Future<int> getRecordNombre() async {
    QuerySnapshot snapshotGameNombre =
        await recordNombreCollection.where('uid', isEqualTo: uid).get();
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              const SizedBox(
                  height:
                      120), // Ajouter un SizedBox avec une hauteur de 20 pixels
              Row(
